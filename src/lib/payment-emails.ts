...
export async function sendPaymentVerificationEmail({
  ...
  const html = `
    ...
    <body>
      <div class="container">
        <div class="header">
          <img src="https://files.creativebydrshakil.com/logo/creative-by-dr-shakil-logo.svg" alt="Creative by Dr. Shakil" style="height:36px;margin:0 auto 12px;display:block;" />
