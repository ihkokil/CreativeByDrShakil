...
import { LayoutDashboard, UserCog, Upload, Trash2, Phone, User as UserIcon } from "lucide-react";
...
export default function StudentUserPage() {
    ...
    const initials = (fullName || user?.email || "ST")
        .split(" ")
        .map((part) => part[0])
        .join("")
        .slice(0, 2)
    ...
    return (
        <DashboardShell
            title="Student User Page"
            subtitle="Manage your personal details and profile image."
            roleLabel="Student"
            ...
            items={navItems}
            activeKey="user"
            onSelect={(key) => router.push(key === "dashboard" ? "/dashboard" : "/dashboard/user")}
                ...
                <form className={styles.form} onSubmit={handleSave}>
                    ...
                    <div className={styles.grid}>
                        ...
                        <div className={styles.field}>
                            ...
                            <input value={bmdcNumber} disabled className={styles.disabledInput} />
                            <small>Your signup details are preserved here for student accounts.</small>
                        </div>
                    </div>
